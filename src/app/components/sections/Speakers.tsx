...
export function Speakers() {
  const speakers = [
    ...
    { name: "Dr. Neeraj Kayal", title: "Researcher", company: "Microsoft Research India", image: neeraj, website: "https://www.microsoft.com/en-us/research/people/neeraka/" },
    { name: "Prof. Ramprasad Saptharishi", title: "Faculty", company: "TIFR Mumbai", image: ramprasad, website: "https://www.tcs.tifr.res.in/~ramprasad/pubs/" },
    { name: "Prof. Madhavan Mukund", title: "Director", company: "Chennai Mathematical Institute", image: madhvan, website: "https://www.cmi.ac.in/~madhavan/" },
    { name: "Prof. Somenath Biswas", title: "Professor (Retd.)", company: "IIT Kanpur", image: somnathsir, website: "https://www.cse.iitk.ac.in/users/sb/" },
    { name: "Prof. V. Vinay", title: "Chairman", company: "Jed-i Technologies", image: vinay, website: "https://in.linkedin.com/in/ainvvy" },
    { name: "Prof. Meena Mahajan", title: "Professor", company: "IMSc", image: meenamahajan, website: "https://en.wikipedia.org/wiki/Meena_Mahajan" },
    { name: "Prof. V. Arvind", title: "Professor", company: "IMSc", image: varvind, website: "https://www.imsc.res.in/~arvind/" },
    { name: "Prof. Jaikumar Radhakrishnan", title: "Professor", company: "ICTS-TIFR", image: radhakrishna, website: "https://www.icts.res.in/people/jaikumar-radhakrishnan1" },
    { name: "Prof. Krishnamurty Subramanian", title: "Professor of Finance", company: "ISB", image: subramanian, website: "https://www.isb.edu/faculty-and-research/faculty-directory/krishnamurthy-subramanian" },
    ...
    { name: "Cmde Dr. Prem Chand", title: "Commander", company: "Former Head WESEE", image: premchand, website: "https://in.linkedin.com/in/dr-prem-chand-47669960" },
    ...
    { name: "Sri Anurag Singh", title: "CEO", company: "FIRST IIT Kanpur", image: anuragsingh, website: "https://www.linkedin.com/in/anurag-singh-8a1101/" },
    { name: "Prof. Vijay Raghavan", title: "Professor", company: "Former PSA", image: vijayraghvan, website: "https://www.ncbs.res.in/faculty/vijay" },
    ...
    { name: "Prof. Vinod K. Singh", title: "Institute Chair Professor", company: "IIT Kanpur", image: vinodk, website: "https://home.iitk.ac.in/~vinodks/" },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {speakers.map((speaker, index) => (
            <div key={index} className="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-[#800020] p-6 text-center hover:-translate-y-2">
              ...
              {speaker.website !== "#" && (
                <a href={speaker.website} target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 text-xs text-gray-700 hover:text-[#800020]">
